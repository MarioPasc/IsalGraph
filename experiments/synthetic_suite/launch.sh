...
# =============================================================================
#
# Master executor that reads experiments/synthetic_suite/config.yaml and dispatches SLURM jobs
# for each enabled benchmark.
#
# Usage:
#   bash experiments/synthetic_suite/launch.sh              # Submit all enabled benchmarks
#   bash experiments/synthetic_suite/launch.sh --dry-run    # Print sbatch commands without submitting
#   bash experiments/synthetic_suite/launch.sh --benchmark random_roundtrip  # Submit single benchmark
#
set -euo pipefail
...
# Main
# ---------------------------------------------------------------------------
BENCHMARKS=("random_roundtrip" "canonical_invariance" "string_length_analysis" "levenshtein_vs_ged" "greedy_optimality_gap" "starting_node_sensitivity" "roundtrip_fixed_point" "alphabet_entropy" "eval_setup" "eval_correlation" "eval_embedding" "eval_computational" "eval_encoding" "topology_complexity_figs")
